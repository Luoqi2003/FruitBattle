...
import shuiguoxiaoxiaole.person.Person;
import shuiguoxiaoxiaole.scene.*;
...
public class Director {
    ...
    public void init(Stage stage) {
        ...
        stage.setTitle("水果消消乐");
        stage.getIcons().add(new Image(getClass().getClassLoader().getResourceAsStream("image/background/logo.png")));
        ...
        PhysicsManager.getInstance().setGamePane((AnchorPane)scene.getRoot());
