...
import shuiguoxiaoxiaole.sprite.Background;
import shuiguoxiaoxiaole.sprite.Card;
import shuiguoxiaoxiaole.sprite.CardList;
import shuiguoxiaoxiaole.sprite.Set;
...
public class GameEndlessScene {
    ...
    public void gameSucceed() {
        ...
        // 背景图片设置
        ImageView background = new ImageView(new Image("/image/background/stage/endlessOver.png"));
        background.setFitHeight(500);
        background.setFitWidth(500);

        // 再来一次按键设置
        ImageView again = new ImageView(new Image("/image/button/stage/againSucceed.png"));
        ...
        again.setOnMouseEntered(event -> again.setOpacity(0.8));
        again.setOnMouseExited(event -> again.setOpacity(1));

        // 返回键设置
        ImageView leave = new ImageView(new Image("/image/button/stage/endlessReturn.png"));
        ...
        leave.setOnMouseEntered(event -> leave.setOpacity(0.8));
        leave.setOnMouseExited(event -> leave.setOpacity(1));

        // 最终得分的显示区域设置
        TextField score = new TextField(String.valueOf(cardList.getModelEndless().getScore()));
        ...
        // 添加到 anchorPane
        anchorPane.getChildren().addAll(background, again, leave, score);
